...
欢迎关注我们的小红书账号：[@璇玑造字](https://www.xiaohongshu.com/user/profile/650815ef0000000012007c55)
...
© 2025 [璇玑造字](https://trionestype.com/)，以 [SIL Open Font License 1.1](http://scripts.sil.org/OFL) 发布。

您**可以**：

- **免费商用本字体**，包括而不限于印刷、LOGO、软件、网页、视频、软件嵌入。
- 复制与再分发本字体。
...
朱雀的西文与符号暂采用 [Alegreya](https://github.com/huertatipografica/Alegreya)。Alegreya 由 Huerta Tipográfica 的 Juan Pablo del Peral 创作，同样以 SIL Open Font License 1.1 发布。
...
**假名与符号：**[韩泳思](https://github.com/yeongsy)

**生产：**[殷叶航](https://github.com/celestialphineas)、[余俊益](https://github.com/Lottin0113)、[李剑桥](https://github.com/RUBiKLi09)

## 关于璇玑造字

[「璇玑造字」](http://trionestype.com/)是[智瑢科技](https://jaderipple.com/)的字库品牌。我们以传统文化为立足基本，从自然风物汲取设计灵感，藉前沿科技更新文字风景。无论技术如何变迁，我们将始终把「人」置于第一位，关心设计者的创意与读者的体验。
