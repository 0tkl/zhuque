...
テスト段階においては、私たちは調査アンケートを実施し、335 名が回答に参加、うち 72 件が有効な専門的フィードバックとして寄せられました。[アンケート結果](survey_result-zh.md)は、朱雀の字形改良や今後の作業計画の立案に重要な示唆を与えてくれました。

最新技術の開発によっても、壮大な目標を持つ「朱雀」プロジェクトには依然として多くの課題が残されています。そのため、プロジェクトをより迅速かつ持続可能に推進するために、私たちはより多くのサポートを得ることを望んでいます。
...
璇璣造字公式サイト：https://www.trionestype.com

私たちの X アカウントもぜひご覧ください： [@TrionesType](https://twitter.com/TrionesType)
...
© 2025 [璇璣造字](https://trionestype.com/)，[SIL Open Font License 1.1](http://scripts.sil.org/OFL) に基づいて公開されています。

以下のことが**できます**：

- 本フォントを**無料で商用利用**できます（印刷、ロゴ、ソフトウェア、ウェブ、動画、ソフトウェアへの組み込みを含む）。
- 本フォントを複製および再配布できます。

以下のことは**できません**：

- フォントのオリジナル版または変更版を単独で販売すること。

ライセンスの詳細は [SIL Open Font License 1.1 の英文原文](http://scripts.sil.org/OFL) を参照してください。

私たちは、「朱雀仿宋」正式版がリリースされるまで、チーム外で改変された非公式版の大規模な配布を控えていただくようお願いしています。もし朱雀を改良したいというご意向がある場合は、ぜひご相談ください。

現在、朱雀のラテン文字と一部記号は [Alegreya](https://github.com/huertatipografica/Alegreya) を暫定的に使用しています。Alegreya は Huerta Tipográfica の Juan Pablo del Peral による作品で、同じく SIL OFL 1.1 で配布されています。
...
**漢字制作：**[殷葉航](https://github.com/celestialphineas)、[余俊益](https://github.com/Lottin0113)、[李剣橋](https://github.com/RUBiKLi09)
